...
db.dinosaurs.insertMany([
    ...
    },
    {
        ...
        name: "Triceratops",
        diet: "Herbivore",
        description: "Triceratops was a rhinoceros-like dinosaur. It walked on four sturdy legs and had three horns on its face along with a large bony plate projecting from the back of its skull (a frill). One short horn above its parrot-like beak and two longer horns (over 3 feet or 1 m long) above its eyes probably provided protection from predators.",
        height: 9.8,
        weight: 12125,
        length: 29.5,
        danger_rating: 2,
    ...
    },
    {
        ...
        name: "Corythosaurus",
        diet: "Herbivore",
        description: "Corythosaurus was a large, plant-eating, duck-billed dinosaur. t had a hollow, bony crest on top of its long head in the shape of a helmet flattened on the sides. Their nostrils went up through the crest, which may have been used to make sounds, as a cooling device, courtship displays, and/or as a sense-of-smell enhancer.",
        height: 16.4,
        weight: 11023,
        length: 26.2,
        danger_rating: 2,
    ...
    },
    {
        ...
        name: "Maiasaura",
        diet: "Herbivore",
        description: "Maiasaura was the first dinosaur that was found alongside its young, eggs, and nests. This suggests that Maiasaura nurtured its young. It was a duck-billed dinosaur with a flat skull and small crests in front of the eyes. This plant-eater had a toothless beak, cheek pouches, and many self-sharpening cheek teeth.",
        height: 8.2,
        weight: 6614,
        length: 29.5,
        danger_rating: 2,
